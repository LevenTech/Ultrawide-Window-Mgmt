...
;---------------------------------------------------
; CHANGES FOR SEETHROUGHORNOT
;---------------------------------------------------
MENU:
;Menu,Tray,DeleteAll
;Menu,Tray,NoStandard
Menu,Tray,Add,Dimmer Config,SETTINGS
Menu,Tray,Add,Dimmer About...,ABOUT
...
{
  IniWrite,%vdimming%,%A_ScriptDir%\Dimmer\%applicationname%.ini,Settings,dimming
}
If vhotkey1<>
{
  hotkey1:=vhotkey1
  IniWrite,%hotkey1%,%A_ScriptDir%\Dimmer\%applicationname%.ini,Settings,hotkey1
}
If vhotkey2<>
{
  hotkey2:=vhotkey2
  IniWrite,%hotkey2%,%A_ScriptDir%\Dimmer\%applicationname%.ini,Settings,hotkey2
}
...
INIREAD:
IniRead,dimming,%A_ScriptDir%\Dimmer\%applicationname%.ini,Settings,dimming
If dimming=Error
  dimming=5
IniRead,hotkey1,%A_ScriptDir%\Dimmer\%applicationname%.ini,Settings,hotkey1
If hotkey1=Error
  hotkey1=^+
IniRead,hotkey2,%A_ScriptDir%\Dimmer\%applicationname%.ini,Settings,hotkey2
If hotkey2=Error
  hotkey2=^-
Hotkey,%hotkey1%,INCREASE
Hotkey,%hotkey2%,DECREASE
